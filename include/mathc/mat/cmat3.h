...
/** dst = mat[row][:] */
static cvec3 cmat3_get_row_v(const signed char *mat, int row) {
...
/** dst = mat[:][col] */
static cvec3 cmat3_get_col_v(const signed char *mat, int col) {
...
/** dst = mat; dst[row][:] = vec */
static cmat3 cmat3_set_row_v(const signed char *mat, const signed char *vec, int row) {
...
/** mat[row][:] = vec; dst = mat */
static cmat3 cmat3_set_this_row_v(signed char *mat, const signed char *vec, int row) {
...
/** dst = mat; dst[:][col] = vec */
static cmat3 cmat3_set_col_v(const signed char *mat, const signed char *vec, int col) {
...
/** mat[:][col] = vec; dst = mat */
static cmat3 cmat3_set_this_col_v(signed char *mat, const signed char *vec, int col) {
    return cmat3_set_this_col((cmat3*) mat, CVec3(vec), col);
}


/** dst = mat; dst[row][:] = scalar */
static cmat3 cmat3_set_row_sca(cmat3 mat, signed char scalar, int row) {
    cmatN_set_row_sca(mat.v, scalar, row, 3);
    return mat;
}
/** dst = mat; dst[row][:] = scalar */
static cmat3 cmat3_set_row_sca_v(const signed char *mat, signed char scalar, int row) {
    return cmat3_set_row_sca(CMat3(mat), scalar, row);
}

/** mat[row][:] = scalar; dst = mat */
static cmat3 cmat3_set_this_row_sca(cmat3 *mat, signed char scalar, int row) {
    cmatN_set_row_sca(mat->v, scalar, row, 3);
    return *mat;
}
/** mat[row][:] = scalar; dst = mat */
static cmat3 cmat3_set_this_row_sca_v(signed char *mat, signed char scalar, int row) {
    return cmat3_set_this_row_sca((cmat3*) mat, scalar, row);
}


/** dst = mat; dst[:][col] = scalar */
static cmat3 cmat3_set_col_sca(cmat3 mat, signed char scalar, int col) {
    cmatN_set_col_sca(mat.v, scalar, col, 3);
    return mat;
}
/** dst = mat; dst[:][col] = scalar */
static cmat3 cmat3_set_col_sca_v(const signed char *mat, signed char scalar, int col) {
    return cmat3_set_col_sca(CMat3(mat), scalar, col);
}

/** mat[:][col] = scalar; dst = mat */
static cmat3 cmat3_set_this_col_sca(cmat3 *mat, signed char scalar, int col) {
    cmatN_set_col_sca(mat->v, scalar, col, 3);
    return *mat;
}
/** mat[:][col] = scalar; dst = mat */
static cmat3 cmat3_set_this_col_sca_v(signed char *mat, signed char scalar, int col) {
...
/** returns sum of diagonal form upper left to lower right */
static int cmat3_trace_v(const signed char *mat) {
...
/** dst = mat^t */
static cmat3 cmat3_transpose_v(const signed char *mat) {
...
/** dst = a @ b */
static cmat3 cmat3_mul_mat_v(const signed char *mat_a, const signed char *mat_b) {
...
/** dst = a @ b */
static cvec3 cmat3_mul_vec_v(const signed char *mat_a, const signed char *vec_b) {
...
/** dst = a @ b */
static cvec3 cvec3_mul_mat_v(const signed char *vec_a, const signed char *mat_b) {
...
static int cmat3_det(cmat3 mat) {
    ...
    signed char a = mat.m[0][0], b = mat.m[0][1], c = mat.m[0][2];
    signed char d = mat.m[1][0], e = mat.m[1][1], f = mat.m[1][2];
    signed char g = mat.m[2][0], h = mat.m[2][1], i = mat.m[2][2];

    return a * (e * i - h * f) - d * (b * i - c * h) + g * (b * f - c * e);
}
/** returns = determinant mat */
static int cmat3_det_v(const signed char *mat) {
...
static cmat3 cmat3_inv(cmat3 mat) {
    ...
    signed char inv_det = (signed char) (1.0f / (a * res.m[0][0] + b * res.m[1][0] + c * res.m[2][0]));

    cvecN_scale(res.v, res.v, inv_det, 9);
    return res;
}
/** dst = inverted mat */
static cmat3 cmat3_inv_v(const signed char *mat) {
...
/** dst = mat[col:col+2, row:row+2] */
static cmat2 cmat3_get_block2_v(const signed char *mat, int row, int col) {
...
/** dst = mat; dst[col:col+2, row:row+2] = block */
static cmat3 cmat3_set_block2_v(const signed char *mat, const signed char *block_2, int row, int col) {
...
/** mat[col:col+2, row:row+2] = block; dst = mat */
static cmat3 cmat3_set_this_block2_v(signed char *mat, const signed char *block_2, int row, int col) {
...
/** dst = mat[:2, :2] */
static cmat2 cmat3_get_upper_left_v(const signed char *mat) {
...
/** dst = mat; dst[:2, :2] = block */
static cmat3 cmat3_set_upper_left_v(const signed char *mat, const signed char *block_2) {
...
/** mat[:2, :2] = block; dst = mat */
static cmat3 cmat3_set_this_upper_left_v(signed char *mat, const signed char *block_2) {
