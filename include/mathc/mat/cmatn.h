...
static void cmatN_eye(signed char *dst_mat, int n) {
    for (int r = 0; r < n; r++) {
        for (int c = 0; c < n; c++)
...
/** dst = mat[row][:] */
static void cmatN_get_row(signed char *dst_vec, const signed char *mat, int row, int n) {
    assert(row >= 0 && row < n);
    for (int c = 0; c < n; c++)
...
/** dst = mat[:][col] */
static void cmatN_get_col(signed char *dst_vec, const signed char *mat, int col, int n) {
    assert(col >= 0 && col < n);
    for (int r = 0; r < n; r++)
...
/** dst[row][:] = vec */
static void cmatN_set_row(signed char *dst_mat, const signed char *vec, int row, int n) {
    assert(row >= 0 && row < n);
    for (int c = 0; c < n; c++)
...
/** dst[:][col] = vec */
static void cmatN_set_col(signed char *dst_mat, const signed char *vec, int col, int n) {
    assert(col >= 0 && col < n);
    for (int r = 0; r < n; r++)
...
/** dst[row][:] = scalar */
static void cmatN_set_row_sca(signed char *dst_mat, signed char scalar, int row, int n) {
    assert(row >= 0 && row < n);
    for (int c = 0; c < n; c++)
...
/** dst[:][col] = scalar */
static void cmatN_set_col_sca(signed char *dst_mat, signed char scalar, int col, int n) {
    assert(col >= 0 && col < n);
    for (int r = 0; r < n; r++)
...
static void cmatN_transpose_no_alias(signed char *restrict dst_mat, const signed char *restrict mat, int n) {
    for (int c = 0; c < n; c++) {
        for (int r = 0; r < n; r++) {
...
/** dst = mat^t */
static void cmatN_transpose(signed char *dst_mat, const signed char *mat, int n) {
#ifdef MATHC_MAX_SIZE
    assert(n <= MATHC_MAX_SIZE);
    signed char tmp[MATHC_MAX_SIZE * MATHC_MAX_SIZE];
#else
    signed char tmp[n * n];
#endif
...
/** dst = a @ b */
static void cmatN_mul_mat(signed char *dst_mat, const signed char *mat_a, const signed char *mat_b, int n) {
#ifdef MATHC_MAX_SIZE
    assert(n <= MATHC_MAX_SIZE);
    signed char tmp[MATHC_MAX_SIZE * MATHC_MAX_SIZE];
#else
...
/** dst = a @ b */
static void cmatN_mul_vec(signed char *dst_vec, const signed char *mat_a, const signed char *vec_b, int n) {
#ifdef MATHC_MAX_SIZE
    assert(n <= MATHC_MAX_SIZE);
...
/** dst = a @ b */
static void cvecN_mul_mat(signed char *dst_vec, const signed char *vec_a, const signed char *mat_b, int n) {
#ifdef MATHC_MAX_SIZE
    assert(n <= MATHC_MAX_SIZE);
    signed char tmp[MATHC_MAX_SIZE];
#else
