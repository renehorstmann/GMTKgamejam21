...
/** dst = (dvec2) v */
static dvec2 dvec2_cast_from_int(const int *v) {
    dvec2 res;
    dvecN_cast_into(res.v, v, 2);
    return res;
}
...
/** dst = (dvec2) v */
static dvec2 dvec2_cast_from_unsigned(const unsigned *v) {
    dvec2 res;
    dvecN_cast_into(res.v, v, 2);
    return res;
}
...
/** dst = (dvec2) v */
static dvec2 dvec2_cast_from_char(const signed char *v) {
    dvec2 res;
    dvecN_cast_into(res.v, v, 2);
    return res;
}
