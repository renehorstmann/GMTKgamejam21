...
/** dst = scalar */
static cvec4 cvec4_set(signed char scalar) {
    cvec4 res;
...
/** dst = a + b */
static cvec4 cvec4_add(cvec4 vec_a, signed char scalar_b) {
    cvec4 res;
...
/** dst = a - b */
static cvec4 cvec4_sub(cvec4 vec_a, signed char scalar_b) {
    cvec4 res;
...
/** dst = a * b */
static cvec4 cvec4_scale(cvec4 vec_a, signed char scalar_b) {
    cvec4 res;
...
/** dst = a / b */
static cvec4 cvec4_div(cvec4 vec_a, signed char scalar_b) {
    cvec4 res;
...
/** dst = x % y */
static cvec4 cvec4_mod(cvec4 vec_x, signed char y) {
    cvec4 res;
...
/** dst = a < b ? a : b */
static cvec4 cvec4_min(cvec4 vec_x, signed char y) {
    cvec4 res;
...
/** dst = a > b ? a : b */
static cvec4 cvec4_max(cvec4 vec_x, signed char y) {
    cvec4 res;
...
/** dst = x < edge ? 0 : 1 */
static cvec4 cvec4_step(cvec4 vec_x, signed char edge) {
    cvec4 res;
...
/** dst = a <= b */
static bvec4 cvec4_less_than_equal(cvec4 vec_a, signed char b) {
    bvec4 res;
...
/** dst = a > b */
static bvec4 cvec4_greater_than(cvec4 vec_a, signed char b) {
    bvec4 res;
...
/** dst = a >= b */
static bvec4 cvec4_greater_than_equal(cvec4 vec_a, signed char b) {
    bvec4 res;
...
/** dst = a == b */
static bvec4 cvec4_equal(cvec4 vec_a, signed char b) {
    bvec4 res;
...
/** dst = a != b */
static bvec4 cvec4_not_equal(cvec4 vec_a, signed char b) {
    bvec4 res;
